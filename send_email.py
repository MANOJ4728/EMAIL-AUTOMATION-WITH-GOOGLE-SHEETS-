...
sender_email = 'manojvardhan4728@gmail.com' # your Gmail email address
password_email = 'msll ajpf njyr fvqh'  # your Gmail password or App Password

def send_email(subject, receiver_email, name, due_date, invoice_no, amount):
    # Create the base text message.
    msg = EmailMessage()
    msg["Subject"] = subject
    msg["From"] = formataddr(("MANOJ VARDHAN.", f"{sender_email}"))
